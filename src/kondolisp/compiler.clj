...
(defn generate-vminst-header []
  (.println System/out
            "/* Generated by KondoLisp. Do not edit manually */")
  (.println System/out
            (format "/* Timestamp: %s */", (str (Date.))))
  (.println System/out "")
  (doseq [[idx inst-spec] (map list (iterate inc 0) *vm-inst-list*)]
    (.println System/out (format "#define\t%s\t%d"
                                 (subs (str (first inst-spec)) 1)
                                 idx))))
...
(defn generate-builtin-header []
  ...
  (.println System/out
            (format "/* Timestamp: %s */", (str (Date.))))
  (.println System/out "")
  (doseq [[idx inst-spec] (map list (iterate inc 0) *vm-builtin-funs*)]
    (.println System/out (format "#define\tF%s\t%d"
                                 (second inst-spec)
                                 idx))))
